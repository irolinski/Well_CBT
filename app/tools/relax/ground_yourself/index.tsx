...
import { groundYourself_tool } from "@/constants/models/tools";
import { Colors } from "@/constants/styles/colorTheme";
import { SCREEN_HEIGHT } from "@/constants/styles/values";

const TOOL_NAME = groundYourself_tool.name;

const GroundYourselfIndexPage = () => {
          ...
          <View className="items-center justify-center">
            <View>
              <View className="my-4 mr-[15%] justify-center">
                ...
                >
                  <Trans
                    i18nKey="tools.ground_yourself.description"
                    ns="tools"
                    components={{
            ...
            <View className="my-16 w-full">
              <AdvanceButton
                ...
                onPress={() =>
                  router.replace(
                    `tools/relax/${TOOL_NAME}/GroundYourself` as Href,
                  )
                }
              />
            </View>
...
export default GroundYourselfIndexPage;
